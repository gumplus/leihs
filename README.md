...
leihs is [Free Software](http://www.gnu.org/philosophy/free-sw.html) under the [GNU General Public License (GPL) v3](http://www.gnu.org/licenses/gpl-3.0.txt).

Some sub-components or third-party modules might be licensed differently, see the LICENSE files included in subdirectories and/or file headers for license details.
